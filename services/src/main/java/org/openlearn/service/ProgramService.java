...
public class ProgramService {
	...
	public List<Program> findAll(Pageable pageable) {
		...
		Optional<User> user = userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin());
		return programRepository.findAllByOrganization(user.get().getOrganization().getId());
	}
	...
	public Program findOne(Long id) {
		...
		Optional<User> user = userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin());
		return programRepository.findOneByIdAndOrganization(id, user.get().getOrganization().getId());
	}
