...
import org.opengive.denver.stem.service.AddressService;
...
public class AddressResource {
	...
	@Timed
	public ResponseEntity<Address> createAddress(@Valid @RequestBody final Address address) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<Address> updateAddress(@Valid @RequestBody final Address address) throws URISyntaxException {
	...
	@Timed
	public ResponseEntity<List<Address>> getAllAddresses(@ApiParam final Pageable pageable) {
		log.debug("REST request to get a page of Addresses");
		final Page<Address> page = addressService.findAll(pageable);
		final HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/addresses");
	...
	public ResponseEntity<Address> getAddress(@PathVariable final Long id) {
		...
		final Address address = addressService.findOne(id);
